      ...
      >
        <div className="glass-panel p-8 sm:p-10 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] bg-dark-bg/60 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            <h2 className="text-2xl font-display font-bold text-white mb-2">Secure Portal</h2>
            <p className="text-gray-400 text-sm font-light">Institutional Client Authentication</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-400 uppercase tracking-widest mb-2">Security Key</label>
              <div className="relative group">
          ...
          <div className="mt-8 text-center border-t border-white/10 pt-6">
            <p className="text-gray-500 text-xs font-light">
              ...
              <a href="#" className="text-neon-blue hover:text-neon-cyan transition-colors underline underline-offset-4">
                Request Access
              </a>
            </p>
          </div>
